...
public static partial class BitmapExtensions {
  ...
  extension(Bitmap @this)
  {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock() => Lock(@this, new(Point.Empty, @this.Size), ImageLockMode.ReadWrite, @this.PixelFormat);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock(Rectangle rect) => Lock(@this, rect, ImageLockMode.ReadWrite, @this.PixelFormat);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock(ImageLockMode flags) => Lock(@this, new(Point.Empty, @this.Size), flags, @this.PixelFormat);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock(PixelFormat format) => Lock(@this, new(Point.Empty, @this.Size), ImageLockMode.ReadWrite, format);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock(Rectangle rect, ImageLockMode flags) => Lock(@this, rect, flags, @this.PixelFormat);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IBitmapLocker Lock(Rectangle rect, PixelFormat format) => Lock(@this, rect, ImageLockMode.ReadWrite, format);
    ...
    /// </code>
    /// </example>
    public Bitmap Resize(int width, int height, InterpolationMode mode = InterpolationMode.Bicubic) {
      Against.ThisIsNull(@this);
    ...
    /// </code>
    /// </example>
    public Bitmap Rotated(float angle, Point? center = null) {
      Against.ThisIsNull(@this);
    ...
    /// </code>
    /// </example>
    public void RotateInplace(float angle, Point? center = null) {
      Against.ThisIsNull(@this);
    ...
    /// </code>
    /// </example>
    public void RotateTo(Bitmap target, float angle, Point? center = null) {
      Against.ThisIsNull(@this);
