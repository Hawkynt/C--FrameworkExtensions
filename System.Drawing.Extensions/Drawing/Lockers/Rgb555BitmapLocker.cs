...
/// <summary>
/// Provides span-based access to 16-bit RGB555 bitmap data.
/// </summary>
internal sealed class Rgb555BitmapLocker : TypedBitmapLockerBase<RgbX555> {

  public override unsafe Span<RgbX555> Pixels {
  ...
  public override Color this[int x, int y] {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    set => this.Pixels[this.Stride * y + x] = new RgbX555(value.R, value.G, value.B);
  }

  public Rgb555BitmapLocker(Bitmap bitmap, ImageLockMode lockMode)
    : base(bitmap, lockMode, 2, PixelFormat.Format16bppRgb555) { }

  public Rgb555BitmapLocker(Bitmap bitmap) : this(bitmap, ImageLockMode.ReadWrite) { }

  public Rgb555BitmapLocker(Bitmap bitmap, Rectangle rect, ImageLockMode lockMode, PixelFormat format)
    : base(bitmap, rect, lockMode, 2, PixelFormat.Format16bppRgb555, PixelFormat.Format16bppRgb555) { }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  protected override Color PixelToColor(RgbX555 pixel) => Color.FromArgb(255, pixel.R, pixel.G, pixel.B);

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  protected override RgbX555 ColorToPixel(Color color) => new(color.R, color.G, color.B);
