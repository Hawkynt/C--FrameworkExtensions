...
/// <summary>
/// Provides span-based access to 16-bit ARGB1555 bitmap data.
/// </summary>
internal sealed class Argb1555BitmapLocker : TypedBitmapLockerBase<Argb1555> {

  public override unsafe Span<Argb1555> Pixels {
  ...
  public override Color this[int x, int y] {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    set => this.Pixels[this.Stride * y + x] = new Argb1555(value.R, value.G, value.B, value.A);
  }

  public Argb1555BitmapLocker(Bitmap bitmap, ImageLockMode lockMode)
    : base(bitmap, lockMode, 2, PixelFormat.Format16bppArgb1555) { }

  public Argb1555BitmapLocker(Bitmap bitmap) : this(bitmap, ImageLockMode.ReadWrite) { }

  public Argb1555BitmapLocker(Bitmap bitmap, Rectangle rect, ImageLockMode lockMode, PixelFormat format)
    : base(bitmap, rect, lockMode, 2, PixelFormat.Format16bppArgb1555, PixelFormat.Format16bppArgb1555) { }

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  protected override Color PixelToColor(Argb1555 pixel) => Color.FromArgb(pixel.A, pixel.R, pixel.G, pixel.B);

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  protected override Argb1555 ColorToPixel(Color color) => new(color.R, color.G, color.B, color.A);
