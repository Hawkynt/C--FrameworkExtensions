...
/// <summary>
/// Crystallize effect — grid-based Voronoi tessellation.
/// Divides the image into irregular crystal-like cells using jittered seed points,
/// coloring each pixel with its nearest seed point's color.
/// </summary>
...
public readonly struct Crystallize(int cellSize, int seed = 0) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDistance, TEquality, TLerp, TEncode, TResult>(
    ...
    => callback.Invoke(new CrystallizePassThroughKernel<TWork, TKey, TPixel, TEncode>());
...
file readonly struct CrystallizePassThroughKernel<TWork, TKey, TPixel, TEncode>
