...
/// <summary>
/// Fresco painting effect with textured surface.
/// Short-stroke oil painting using 3 luminance bins, with hash-based texture noise added.
/// Always uses frame-level random access.
/// </summary>
[FilterInfo("Fresco",
  Description = "Fresco painting effect with textured surface", Category = FilterCategory.Artistic)]
public readonly struct Fresco(int brushSize = 2, float textureAmount = 0.5f) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new FrescoFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
...
file readonly struct FrescoFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  int brushSize, float textureAmount, int seed, int sourceWidth, int sourceHeight)
