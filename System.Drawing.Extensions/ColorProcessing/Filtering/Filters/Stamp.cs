...
/// <summary>
/// Rubber stamp effect with threshold.
/// Averages luminance within a configurable neighborhood radius
/// and thresholds to produce a clean black-and-white stamp appearance.
/// </summary>
[FilterInfo("Stamp",
  Description = "Rubber stamp effect with threshold", Category = FilterCategory.Artistic)]
public readonly struct Stamp(float lightDarkBalance = 0.5f, float smoothness = 5f) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new StampFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
...
file readonly struct StampFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  float lightDarkBalance, int radius, int sourceWidth, int sourceHeight)
  ...
  public unsafe void Resample(
    ...
    var bw = avgLum > lightDarkBalance ? 1f : 0f;
