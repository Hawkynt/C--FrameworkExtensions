...
/// <summary>
/// Spread distortion — randomly displaces each pixel within a configurable range using a positional hash.
/// </summary>
[FilterInfo("Spread",
...
public readonly struct Spread(int amount, int seed = 0) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDistance, TEquality, TLerp, TEncode, TResult>(
    ...
    => throw new NotSupportedException("Spread requires IFrameFilter dispatch (UsesFrameAccess=true); IPixelFilter direct invocation is not supported. Use Bitmap.ApplyFilter(...) which routes IFrameFilter filters through the resampler pipeline.");
