...
/// <summary>
/// Spherize distortion — applies spherical refraction to the image, creating a bulge or pinch effect.
/// </summary>
[FilterInfo("Spherize",
  Description = "Spherical refraction distortion with adjustable amount", Category = FilterCategory.Distortion)]
public readonly struct Spherize(float amount) : IPixelFilter, IFrameFilter {
  private readonly float _amount = Math.Max(-1f, Math.Min(1f, amount));

  public Spherize() : this(0.5f) { }
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new SpherizeFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
...
file readonly struct SpherizeFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  ...
  public unsafe void Resample(
    ...
    var nx = (destX - cx) / cx;
    var ny = (destY - cy) / cy;
    var dist = (float)Math.Sqrt(nx * nx + ny * ny);
