...
/// <summary>
/// Solarizes the image by inverting channels that exceed a threshold.
/// </summary>
[FilterInfo("Solarize",
  Description = "Invert channels above threshold", Category = FilterCategory.ColorCorrection)]
public readonly struct Solarize(float threshold = 0.5f) : IPixelFilter {
...
file readonly struct SolarizeKernel<TWork, TKey, TPixel, TEncode>(float threshold)
  ...
  public unsafe void Scale(
    ...
    if (r > threshold) r = 1f - r;
    if (g > threshold) g = 1f - g;
    if (b > threshold) b = 1f - b;
