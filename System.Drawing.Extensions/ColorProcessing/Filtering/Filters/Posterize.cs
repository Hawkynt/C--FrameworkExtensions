...
/// </summary>
[FilterInfo("Posterize",
  Description = "Reduce color levels per channel", Category = FilterCategory.ColorCorrection)]
public readonly struct Posterize(int levels = 4) : IPixelFilter {
