...
/// </summary>
[FilterInfo("Gamma",
  Description = "Apply gamma correction curve", Category = FilterCategory.ColorCorrection)]
public readonly struct Gamma(float gamma = 1f) : IPixelFilter {
  private readonly float _invGamma = 1f / gamma;
