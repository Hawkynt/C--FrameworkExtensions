...
public readonly struct HalftonePattern(int patternSize = 4, int patternType = 0) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDistance, TEquality, TLerp, TEncode, TResult>(
    ...
    => callback.Invoke(new HalftonePatternPassThroughKernel<TWork, TKey, TPixel, TEncode>());
...
file readonly struct HalftonePatternPassThroughKernel<TWork, TKey, TPixel, TEncode>
