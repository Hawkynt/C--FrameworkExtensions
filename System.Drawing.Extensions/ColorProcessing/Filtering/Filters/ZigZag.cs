...
/// <summary>
/// ZigZag distortion — displaces pixels radially from the center along sinusoidal ridges.
/// </summary>
[FilterInfo("ZigZag",
  Description = "Radial zigzag displacement from center", Category = FilterCategory.Distortion)]
public readonly struct ZigZag(float amount = 5f, int ridges = 5) : IPixelFilter, IFrameFilter {
  private readonly float _amount = amount;
  private readonly int _ridges = Math.Max(1, ridges);
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new ZigZagFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
...
file readonly struct ZigZagFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  float amount, int ridges, int sourceWidth, int sourceHeight)
