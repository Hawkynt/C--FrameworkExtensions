...
/// <summary>
/// Shear distortion — linearly displaces pixels along one axis based on position along the other axis.
/// </summary>
[FilterInfo("Shear",
  Description = "Linear shear displacement", Category = FilterCategory.Distortion)]
public readonly struct Shear(float amount = 10f, bool horizontal = true) : IPixelFilter, IFrameFilter {
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new ShearFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
...
file readonly struct ShearFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  float amount, bool horizontal, int sourceWidth, int sourceHeight)
  ...
  public int Radius => (int)Math.Ceiling(Math.Abs(amount) * 0.5f) + 1;
