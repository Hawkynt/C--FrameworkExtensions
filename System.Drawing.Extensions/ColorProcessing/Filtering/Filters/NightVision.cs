...
/// <summary>
/// Simulates night-vision goggles: green monochrome with amplified brightness.
/// </summary>
[FilterInfo("NightVision",
  Description = "Green monochrome night-vision goggle effect with brightness amplification", Category = FilterCategory.Artistic)]
public readonly struct NightVision(float amplification = 2f) : IPixelFilter {
  private readonly float _amplification = Math.Max(1f, Math.Min(5f, amplification));
