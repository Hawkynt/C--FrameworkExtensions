...
public readonly struct HighPass : IPixelFilter, IFrameFilter {
  ...
  public HighPass() : this(1, 1) { }

  public HighPass(int radiusX = 1, int radiusY = 1) {
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDistance, TEquality, TLerp, TEncode, TResult>(
    ...
    => callback.Invoke(new HighPassKernel<TWork, TKey, TPixel, TEncode>(
      this._xw0, this._xw1, this._xw2, this._yw0, this._yw1, this._yw2));
  ...
  public TResult InvokeFrameKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    where TEncode : struct, IEncode<TWork, TPixel>
    => callback.Invoke(new HighPassFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  ...
  public static HighPass Default => new();
}

file readonly struct HighPassKernel<TWork, TKey, TPixel, TEncode>(
...
file readonly struct HighPassFrameKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
