...
/// <summary>
/// Interface for 4-component float color spaces with alpha (e.g., LinearRgbaF).
/// </summary>
...
/// Alpha is always straight (non-premultiplied) in working space.
/// </remarks>
public interface IColorSpace4F<out TSelf> : IColorSpace4<TSelf>
  where TSelf : unmanaged, IColorSpace4F<TSelf> {
  ...
  static abstract TSelf Create(float c1, float c2, float c3, float a);
#endif
}
