...
/// <summary>
/// Weighted Chebyshev (L-infinity) distance metric for 3-component color spaces.
/// </summary>
...
/// </remarks>
public readonly struct WeightedChebyshev3<TKey>(float w1, float w2, float w3) : IColorMetric<TKey>
...
/// <summary>
/// Non-generic weighted Chebyshev distance for LinearRgbF colors.
/// </summary>
public readonly struct WeightedChebyshevRgb(float wR, float wG, float wB) : IColorMetric<Working.LinearRgbF> {

  /// <summary>
  /// Calculates the weighted Chebyshev distance between two RGB colors.
  /// </summary>
  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public float Distance(in Working.LinearRgbF a, in Working.LinearRgbF b) {
    var dr = MathF.Abs(a.R - b.R) * wR;
    var dg = MathF.Abs(a.G - b.G) * wG;
    var db = MathF.Abs(a.B - b.B) * wB;
