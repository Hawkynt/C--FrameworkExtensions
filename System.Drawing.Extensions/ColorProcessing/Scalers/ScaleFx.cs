...
file readonly struct ScaleFx3xKernel<TWork, TKey, TPixel, TMetric, TEncode>
  ...
  public unsafe void Scale(in NeighborWindow<TWork, TKey> window, TPixel* dest, int destStride, in TEncode encoder) {
    ...
    var a = window.M1M1; var b = window.P0M1; var c = window.P1M1;
    var d = window.M1P0; var e = window.P0P0; var f = window.P1P0;
    var g = window.M1P1; var h = window.P0P1; var i = window.P1P1;

    // Additional neighbors for extended analysis
    var a0 = window.M2M1; var b0 = window.P0M2; var c0 = window.P2M1;
    var d0 = window.M2P0;                         var f0 = window.P2P0;
    var g0 = window.M2P1; var h0 = window.P0P2; var i0 = window.P2P1;
