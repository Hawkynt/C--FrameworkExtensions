...
/// <summary>
/// Callback interface for receiving a concrete downscale kernel type.
/// </summary>
...
/// The downscaler invokes this callback with its concrete kernel type,
/// allowing the callback to call methods that require struct constraints.
/// </para>
/// </remarks>
public interface IDownscaleKernelCallback<TWork, TKey, TPixel, TEncode, out TResult>
  ...
  /// <summary>
  /// Invokes the callback with a concrete downscale kernel type.
  /// </summary>
