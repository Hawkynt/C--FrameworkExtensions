...
public readonly struct Scale : IPixelScaler {
  ...
  /// <inheritdoc />
  ScaleFactor IScalerInfo.Scale => this._scaleFactor == 0 ? new(2, 2) : new(this._scaleFactor, this._scaleFactor);
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDistance, TEquality, TLerp, TEncode, TResult>(
    ...
    => this._scaleFactor switch {
      0 or 2 => callback.Invoke(new Scale2xKernel<TWork, TKey, TPixel, TEquality, TLerp, TEncode>(equality, lerp)),
