...
/// <summary>
/// HQ2x3 pattern lookup table implementation.
...
/// </summary>
internal static class Hq2x3Patterns {
  /// <summary>
  /// Applies the HQ2x3 pattern for the given pattern byte.
  /// </summary>
  public static void Apply<TWork, TKey, TLerp, TEquality>(
    ...
    switch (pattern) {
      ...
      case 165:
        ...
        e11 = lerp.Lerp(w4, w5, 13, 3);
        e20 = lerp.Lerp(w4, w7, w3, 9, 4, 3);
        e21 = lerp.Lerp(w4, w7, w5, 9, 4, 3);
        break;
      case 2:
      case 34:
      case 130:
      case 162:
        e00 = lerp.Lerp(w4, w0, 13, 3);
        e01 = lerp.Lerp(w4, w2, 13, 3);
        e10 = lerp.Lerp(w4, w3, 13, 3);
        e11 = lerp.Lerp(w4, w5, 13, 3);
        e20 = lerp.Lerp(w4, w7, w3, 9, 4, 3);
        e21 = lerp.Lerp(w4, w7, w5, 9, 4, 3);
      ...
      case 136:
      case 140:
        e00 = lerp.Lerp(w4, w0, w1, 12, 3, 1);
        e01 = lerp.Lerp(w4, w1, w5, 9, 4, 3);
        e10 = w4;
        e11 = lerp.Lerp(w4, w5, 13, 3);
        e20 = lerp.Lerp(w4, w6, w7, 12, 3, 1);
        e21 = lerp.Lerp(w4, w7, w5, 9, 4, 3);
        break;
      case 9:
      case 13:
      ...
      case 51:
        ...
        if (!equality.Equals(c1, c5)) {
          ...
          e00 = lerp.Lerp(w4, w1, w3, 7, 6, 3);
          e01 = lerp.Lerp(w1, w5, w4, 10, 5, 1);
          e11 = lerp.Lerp(w4, w5, 13, 3);
        }
        break;
      case 20:
      ...
      case 174:
        ...
        e20 = lerp.Lerp(w4, w7, 3, 1);
        e21 = lerp.Lerp(w4, w7, w5, 9, 4, 3);
        e00 = !equality.Equals(c1, c3) ? lerp.Lerp(w4, w0, 13, 3) : lerp.Lerp(w4, w1, w3, 10, 3, 3);
        break;
      case 47:
      case 175:
        e01 = lerp.Lerp(w4, w5, 13, 3);
      ...
      case 58:
        ...
        e21 = lerp.Lerp(w4, w8, w7, 12, 3, 1);
        e00 = !equality.Equals(c1, c3) ? lerp.Lerp(w4, w0, 13, 3) : lerp.Lerp(w4, w1, w3, 10, 3, 3);
        e01 = !equality.Equals(c1, c5) ? lerp.Lerp(w4, w2, 13, 3) : lerp.Lerp(w4, w1, w5, 10, 3, 3);
        break;
      case 59:
        e11 = w4;
        e20 = lerp.Lerp(w4, w7, 3, 1);
      ...
      case 78:
        ...
        e11 = lerp.Lerp(w4, w5, 13, 3);
        e21 = lerp.Lerp(w4, w8, 13, 3);
        e20 = !equality.Equals(c7, c3) ? lerp.Lerp(w4, w6, 13, 3) : lerp.Lerp(w4, w3, w7, 10, 3, 3);
        e00 = !equality.Equals(c1, c3) ? lerp.Lerp(w4, w0, 13, 3) : lerp.Lerp(w4, w1, w3, 10, 3, 3);
        break;
      case 79:
        e11 = lerp.Lerp(w4, w5, 13, 3);
      ...
      case 83:
        ...
        e11 = w4;
        e20 = lerp.Lerp(w4, w6, 13, 3);
        e21 = !equality.Equals(c7, c5) ? lerp.Lerp(w4, w8, 13, 3) : lerp.Lerp(w4, w5, w7, 10, 3, 3);
        e01 = !equality.Equals(c1, c5) ? lerp.Lerp(w4, w2, 13, 3) : lerp.Lerp(w4, w1, w5, 10, 3, 3);
        break;
      case 84:
      case 85:
        ...
        if (!equality.Equals(c7, c5)) {
          ...
          e01 = lerp.Lerp(w4, w1, w5, 9, 4, 3);
          e11 = lerp.Lerp(w4, w5, 1, 1);
          e20 = lerp.Lerp(w4, w6, w7, 12, 3, 1);
          e21 = lerp.Lerp(w7, w5, w4, 7, 5, 4);
        }
        break;
      case 86:
        e10 = lerp.Lerp(w4, w3, 13, 3);
      ...
      case 113:
        ...
        if (!equality.Equals(c7, c5)) {
          ...
          e11 = lerp.Lerp(w4, w5, 13, 3);
          e20 = lerp.Lerp(w7, w4, w3, 7, 6, 3);
          e21 = lerp.Lerp(w7, w5, w4, 10, 5, 1);
        }
        break;
      case 114:
        e00 = lerp.Lerp(w4, w0, 13, 3);
      ...
      case 204:
        ...
        if (!equality.Equals(c7, c3)) {
          ...
          e10 = lerp.Lerp(w4, w3, 13, 3);
          e20 = lerp.Lerp(w7, w3, w4, 10, 5, 1);
          e21 = lerp.Lerp(w7, w4, w5, 7, 6, 3);
        }
        break;
      case 201:
      case 205:
      ...
      case 251:
        ...
        e11 = !equality.Equals(c7, c5) ? w4 : lerp.Lerp(w4, w5, 15, 1);
        if (!equality.Equals(c1, c3)) {
          e00 = w4;
          e01 = lerp.Lerp(w4, w2, 13, 3);
        } else {
      ...
      case 254:
        if (equality.Equals(c7, c3))
          ...
          e20 = w4;
        e10 = !equality.Equals(c7, c3) ? w4 : lerp.Lerp(w4, w3, 15, 1);
        if (!equality.Equals(c7, c5)) {
          e11 = w4;
          e21 = w4;
        } else {
