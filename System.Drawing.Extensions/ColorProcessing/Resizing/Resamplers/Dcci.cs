...
public readonly struct Dcci : IResampler {
  ...
  public TResult InvokeKernel<TWork, TKey, TPixel, TDecode, TProject, TEncode, TResult>(
    ...
    => callback.Invoke(new DcciKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
      sourceWidth, sourceHeight, targetWidth, targetHeight, this._cubicA, this._coherenceThreshold, useCenteredGrid));
...
file readonly struct DcciKernel<TPixel, TWork, TKey, TDecode, TProject, TEncode>(
  int sourceWidth, int sourceHeight, int targetWidth, int targetHeight, float cubicA, float coherenceThreshold, bool useCenteredGrid)
