...
/// <summary>
/// Projects LinearRgbaF to Lab4F using D65 illuminant.
/// </summary>
/// <remarks>
/// Uses LUT-based conversion for performance:
/// 1. Linear RGB to XYZ (matrix multiplication)
/// 2. XYZ to Lab (f-function with LUT)
/// Alpha is preserved unchanged (straight, non-premultiplied).
/// </remarks>
public readonly struct LinearRgbaFToLab4F : IProject<LinearRgbaF, Lab4F> {

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public Lab4F Project(in LinearRgbaF work) {
    // Linear RGB to XYZ
...
/// <summary>
/// Projects Lab4F back to LinearRgbaF using D65 illuminant.
/// </summary>
/// <remarks>
/// Alpha is preserved unchanged (straight, non-premultiplied).
/// </remarks>
public readonly struct Lab4FToLinearRgbaF : IProject<Lab4F, LinearRgbaF> {

  [MethodImpl(MethodImplOptions.AggressiveInlining)]
  public LinearRgbaF Project(in Lab4F lab) {
    // Lab to XYZ
