...
/// <summary>
/// Base interface for 3-component color spaces providing normalized access.
/// </summary>
/// <typeparam name="TSelf">The implementing type for CRTP pattern.</typeparam>
public interface IColorSpace3<out TSelf> : IColorSpace
  where TSelf : unmanaged, IColorSpace3<TSelf> {
