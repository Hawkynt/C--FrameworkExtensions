...
/// <summary>
/// Base interface for 4-component color spaces with alpha providing normalized access.
/// </summary>
/// <typeparam name="TSelf">The implementing type for CRTP pattern.</typeparam>
public interface IColorSpace4<out TSelf> : IColorSpace
  where TSelf : unmanaged, IColorSpace4<TSelf> {
