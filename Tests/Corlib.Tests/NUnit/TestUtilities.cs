...
#pragma warning restore CA1825
  ...
  ///   where the delegate takes an array of objects as parameters and returns a value of type
  ///   <typeparamref name="TResult" />.
  /// </returns>
  /// <exception cref="ArgumentNullException">
  ///   Thrown if <paramref name="this" /> is <see langword="null" />, or <paramref name="methodName" /> is
  ...
  ///   Ensure the parameter types of the non-public method match the types in <paramref name="args" /> to avoid runtime
  ///   exceptions.
  /// </remarks>
  ...
  ///   by accepting an array of objects as parameters for the method invocation.
  ///   If <paramref name="args" /> is <see langword="null" /> or empty, it invokes the method with no parameters.
  ///   Ensure the parameter types of the non-public static method match the types in <paramref name="args" /> to avoid
  ///   runtime exceptions.
  /// </remarks>
  ...
  /// </returns>
  /// <exception cref="ArgumentNullException">
  ///   Thrown if <paramref name="this" /> is <see langword="null" /> or if <paramref name="methodName" /> is
  ///   <see langword="null" /> or an empty string.
  /// </exception>
  /// <exception cref="ArgumentException">
  ...
  ///   <para>
  ///     This method is useful for accessing types that are typically hidden from external assemblies,
  ///     such as internal or private classes, structures, interfaces, or enums defined within the assembly.
  ///   </para>
