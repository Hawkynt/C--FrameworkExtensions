...
public class OrderedDictionaryTests {
  ...
  public void Values_ReturnsValuesInInsertionOrder() {
    // Arrange
    var dictionary = new OrderedDictionary<string, int>();
    var keyValuePairs = new[] { ("third", 300), ("first", 100), ("second", 200) };
  ...
  public void GetEnumerator_ReturnsItemsInInsertionOrder() {
    // Arrange
    var dictionary = new OrderedDictionary<string, int>();
    var expectedPairs = new[] { new KeyValuePair<string, int>("delta", 4), new KeyValuePair<string, int>("alpha", 1), new KeyValuePair<string, int>("gamma", 3), new KeyValuePair<string, int>("beta", 2) };
  ...
  public void WithComplexTypes_MaintainsOrderForComplexKeyValueTypes() {
    ...
    var dates = new[] { new DateTime(2023, 12, 25), new DateTime(2023, 1, 1), new DateTime(2023, 7, 4) };
