...
public class DictionaryExtensionsTests {
  ...
  public void HasKeyDo_ExistingKey_ActionExecuted_ReturnsTrue() {
    ...
    // Act
    var result = dictionary.HasKeyDo("key1", (key, value) => {
      actionExecuted = true;
      capturedKey = key;
      capturedValue = value;
    });
  ...
  public void HasKeyDo_NonExistentKey_ActionNotExecuted_ReturnsFalse() {
    ...
    // Act
    var result = dictionary.HasKeyDo("nonexistent", (key, value) => {
      actionExecuted = true;
    });
  ...
  public void HasKeyDo_ValueOnlyAction_ExistingKey_ActionExecuted_ReturnsTrue() {
    ...
    // Act
    var result = dictionary.HasKeyDo("key1", value => {
      capturedValue = value;
    });
  ...
  public void AddRange_LargeNumberOfItems_PerformanceTest() {
    ...
    var pairs = Enumerable.Range(0, itemCount)
