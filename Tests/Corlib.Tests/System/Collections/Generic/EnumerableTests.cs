...
public class EnumerableTests {
  ...
  [TestCase(2, 1337)]
  [TestCase(16, 1337)]
  [TestCase(128 * 1024, 1337)]
  [TestCase(128 * 1024 + 1, 1337)]
  [TestCase(128 * 1024 - 1, 1337)]
  public void ShuffleArrays(int elementCount, int seed) {
  ...
  public void ShuffleEnumerables(int elementCount, int seed) {
    var input = elementCount < 0 ? null : elementCount == 0 ? [] : Enumerable.Range(0, elementCount);
    ...
    switch (elementCount) {
      ...
      case 1:
        ...
        Assert.That(outputList[0], Is.EqualTo(input.First()), "One element alone can't be shuffled");
        return;
      case 2:
        Assert.That(outputEnumeration, Is.EquivalentTo(input), "Shuffling should return all source elements");
        Assert.That(outputArray, Is.EquivalentTo(input), "Shuffling should return all source elements");
