...
public class EnumComprehensiveTest {
  ...
  private class CustomTestAttribute : Attribute {
    ...
    public CustomTestAttribute(string value) => Value = value;
  }

  private enum CustomAttributedEnum {
    [CustomTest("custom-none")]
    None,
    [CustomTest("custom-first")]
    First,
    [CustomTest("custom-second")]
    Second,
  ...
  */
  ...
  [Test]
  public void StringExtensions_ParseEnum_WithNonMatchingString_ThrowsException() {
    Assert.Throws<ArgumentException>(() => {
      "non-existent".ParseEnum<AttributedEnum, DescriptionAttribute>(attr => attr.Description);
    });
  }
  ...
  [Test]
  public void StringExtensions_ParseEnum_BasicEnumCaseSensitive_ThrowsOnWrongCase() {
    Assert.Throws<ArgumentException>(() => {
      "first".ParseEnum<BasicEnum>(ignoreCase: false);
    });
  }
  ...
  [Test]
  public void StringExtensions_ParseEnum_WithInvalidValue_ThrowsException() {
    Assert.Throws<ArgumentException>(() => {
      "InvalidValue".ParseEnum<BasicEnum>();
    });
  }
  ...
  public void StringExtensions_ParseEnum_Span_ValidValue_ParsesCorrectly() {
    ReadOnlySpan<char> span = "Second".AsSpan();
  ...
  public void StringExtensions_TryParseEnum_Span_ValidValue_ReturnsTrueAndEnum() {
    ReadOnlySpan<char> span = "Third".AsSpan();
  ...
  public void StringExtensions_TryParseEnum_Span_InvalidValue_ReturnsFalseAndDefault() {
    ReadOnlySpan<char> span = "InvalidValue".AsSpan();
    var success = span.TryParseEnum<BasicEnum>(out var result);
  ...
  [Test]
  public void StringExtensions_ParseEnum_NullString_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => {
      ((string)null).ParseEnum<BasicEnum>();
    });
  }

  [Test]
  public void StringExtensions_ParseEnum_EmptyString_ThrowsArgumentException() {
    Assert.Throws<ArgumentException>(() => {
      "".ParseEnum<BasicEnum>();
    });
  }
  ...
  [Test]
  public void StringExtensions_ParseEnum_WhitespaceString_ThrowsArgumentException() {
    Assert.Throws<ArgumentException>(() => {
      "   ".ParseEnum<BasicEnum>();
    });
  }
  ...
  [Test]
  public void StringExtensions_ParseEnum_AttributeBased_NullString_ThrowsArgumentNullException() {
    Assert.Throws<NullReferenceException>(() => {
      ((string)null).ParseEnum<AttributedEnum, DescriptionAttribute>(attr => attr.Description);
    });
  }

  [Test]
  public void StringExtensions_ParseEnum_AttributeBased_NullSelector_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => {
      "test".ParseEnum<AttributedEnum, DescriptionAttribute>((Func<DescriptionAttribute, string>)null);
    });
  }
