...
public class TypeTests {
  ...
  private class SimpleTestClass {
    ...
    public SimpleTestClass() => Value = "default";
    public SimpleTestClass(string value) => Value = value;
    public SimpleTestClass(int number) => Value = number.ToString();
    public SimpleTestClass(string value, int number) => Value = $"{value}:{number}";
  }
  ...
  private class GenericTestClass<T> {
    ...
    public GenericTestClass(T value) => Value = value;
  }
  ...
  private class NoParameterlessConstructor {
    ...
    public NoParameterlessConstructor(string value) => Value = value;
  }
  ...
  public void TypeExtensions_GetFieldOrPropertyAttributeValue_WithNonExistentMember_Throws() {
    ...
    Assert.Throws<ArgumentException>(()=> type.GetFieldOrPropertyAttributeValue<DescriptionAttribute, string>(
      "NonExistentMember",
      attr => attr.Description
    ));
  }
  ...
  [Test]
  public void TypeExtensions_IsStringType_StringType_ReturnsTrue() {
    Assert.That(typeof(string).IsStringType(), Is.True);
  }
  ...
  [Test]
  public void TypeExtensions_CreateInstance_NoParameterlessConstructor_ThrowsException() {
    Assert.Throws<MissingMethodException>(() => {
      typeof(NoParameterlessConstructor).CreateInstance<NoParameterlessConstructor>();
    });
  }

  [Test]
  public void TypeExtensions_CreateInstance_AbstractClass_ThrowsException() {
    Assert.Throws<MissingMethodException>(() => {
      typeof(AbstractTestClass).CreateInstance<AbstractTestClass>();
    });
  }
  ...
  [Test]
  public void TypeExtensions_FromConstructor_NonExistentConstructor_ThrowsException() {
    Assert.Throws<MissingMethodException>(() => {
      typeof(SimpleTestClass).FromConstructor<SimpleTestClass, double>(3.14);
    });
  }
  ...
  [Test]
  public void TypeExtensions_GetStaticFieldValue_NonExistentField_ThrowsException() {
    Assert.Throws<ArgumentException>(() => {
      typeof(string).GetStaticFieldValue<string>("NonExistentField");
    });
  }

  [Test]
  public void TypeExtensions_GetStaticPropertyValue_NonExistentProperty_ThrowsException() {
    Assert.Throws<ArgumentException>(() => {
      typeof(string).GetStaticPropertyValue<string>("NonExistentProperty");
    });
  }
  ...
  public void TypeExtensions_IsCastableTo_NullTarget_ThrowsArgumentNullException() {
    ...
    Assert.Throws<ArgumentNullException>(() => {
      type.IsCastableTo(null);
    });
  }

  [Test]
  public void TypeExtensions_CreateInstance_WrongGenericType_ThrowsInvalidCastException() {
    Assert.Throws<InvalidOperationException>(() => {
      typeof(SimpleTestClass).CreateInstance<string>();
    });
  }
  ...
  public void TypeExtensions_GetFieldOrPropertyAttributeValue_NullGetter_ThrowsArgumentNullException() {
    ...
    Assert.Throws<ArgumentNullException>(() => {
      type.GetFieldOrPropertyAttributeValue<DescriptionAttribute, string>("TestField", null);
    });
  }
  ...
  public void Performance_TypeInspection_BulkOperations_EfficientExecution() {
    var types = new[] { 
      typeof(int), typeof(string), typeof(DateTime), typeof(bool), 
      typeof(double), typeof(TestEnum), typeof(int?), typeof(List<string>)
    };
