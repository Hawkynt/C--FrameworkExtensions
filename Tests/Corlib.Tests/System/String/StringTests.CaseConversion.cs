...
public partial class StringTests {
  ...
  [TestCase("hello", "hello")]
  [TestCase("Hello123World", "hello_123_world")]
  [TestCase("HTTPSConnection", "https_connection")]
  [TestCase("XMLHttpRequest", "xml_http_request")]
  [TestCase("", "")]
  [TestCase("a", "a")]
  [TestCase("userID", "user_id")]
  [TestCase("HTML5Parser", "html_5_parser")]
  [TestCase("iOS15Update", "i_os_15_update")]
