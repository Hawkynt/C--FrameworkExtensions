...
public class ImmutableDictionaryTests {
  ...
  public void CreateRange_FromEnumerable_CreatesDictionary() {
    ...
    var dict = ImmutableDictionary.CreateRange(source);
  ...
  [Test]
  [Category("HappyPath")]
  public void ToImmutableDictionary_FromEnumerable_CreatesDictionary() {
    var source = new[] { 1, 2, 3 };
    var dict = source.ToImmutableDictionary(x => x.ToString(), x => x);
  ...
  public void Remove_ExistingKey_ReturnsNewDictionaryWithoutElement() {
    var dict = ImmutableDictionary<string, int>.Empty.Add("a", 1).Add("b", 2);
  ...
  public void SetItem_ExistingKey_UpdatesElement() {
    var dict = ImmutableDictionary<string, int>.Empty.Add("key", 1);
    var newDict = dict.SetItem("key", 42);
    Assert.That(newDict["key"], Is.EqualTo(42));
  ...
  public void ContainsKey_ExistingKey_ReturnsTrue() {
    var dict = ImmutableDictionary<string, int>.Empty.Add("key", 42);
  ...
  [Test]
  [Category("HappyPath")]
  public void Builder_ToImmutable_CreatesImmutableDictionary() {
    var builder = ImmutableDictionary.CreateBuilder<string, int>();
    builder.Add("a", 1);
    builder.Add("b", 2);
  ...
  public void IDictionary_Add_ThrowsNotSupportedException() {
    IDictionary<string, int> dict = ImmutableDictionary<string, int>.Empty.Add("a", 1);
  ...
  public void ICollection_IsReadOnly_ReturnsTrue() {
    ICollection<KeyValuePair<string, int>> dict = ImmutableDictionary<string, int>.Empty;
