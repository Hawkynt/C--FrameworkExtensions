...
public class ImmutableSortedSetTests {
  ...
  public void Empty_ReturnsEmptySet() {
    var empty = ImmutableSortedSet<int>.Empty;
  ...
  public void Create_NoArgs_ReturnsEmptySet() {
    var set = ImmutableSortedSet.Create<int>();
  ...
  public void Create_SingleItem_ReturnsSetWithOneElement() {
    var set = ImmutableSortedSet.Create(42);
  ...
  public void Create_MultipleItems_ReturnsSetWithElements() {
    var set = ImmutableSortedSet.CreateRange([1, 2, 3]);
  ...
  public void Create_WithComparer_UsesComparer() {
    var set = ImmutableSortedSet.Create(StringComparer.OrdinalIgnoreCase, "A");
  ...
  public void CreateRange_FromEnumerable_CreatesSet() {
    ...
    var set = ImmutableSortedSet.CreateRange(source);
    Assert.That(set.Count, Is.EqualTo(3));
  }
  ...
  [Test]
  [Category("HappyPath")]
  public void ToImmutableSortedSet_FromEnumerable_CreatesSet() {
    var source = new[] { 1, 2, 3 };
    var set = source.ToImmutableSortedSet();
    Assert.That(set.Count, Is.EqualTo(3));
  }
  ...
  public void Add_NewElement_ReturnsNewSetWithElement() {
    var set = ImmutableSortedSet.CreateRange([1, 2]);
  ...
  public void Enumeration_ReturnsSortedOrder() {
    var set = ImmutableSortedSet.CreateRange([3, 1, 2]);
  ...
  [Test]
  [Category("HappyPath")]
  public void Builder_ToImmutable_CreatesImmutableSortedSet() {
    var builder = ImmutableSortedSet.CreateBuilder<int>();
    builder.Add(1);
    builder.Add(2);
  ...
  public void ICollection_Add_ThrowsNotSupportedException() {
    ICollection<int> set = ImmutableSortedSet.CreateRange([1, 2, 3]);
