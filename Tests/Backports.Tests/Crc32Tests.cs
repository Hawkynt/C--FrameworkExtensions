...
public class Crc32Tests {
  ...
  public void Hash_EmptyArray_ReturnsConsistentHash() {
    ...
    var hash1 = Crc32.Hash(data);
    var hash2 = Crc32.Hash(data);
  ...
  public void Hash_DifferentData_ReturnsDifferentHashes() {
    ...
    var hash1 = Crc32.Hash(data1);
    var hash2 = Crc32.Hash(data2);
  ...
  public void Append_MultipleChunks_ProducesConsistentHash() {
    ...
    var hasher1 = new Crc32();
    hasher1.Append(data);
    var hash1 = hasher1.GetCurrentHash();

    var hasher2 = new Crc32();
  ...
  public void Hash_NullArray_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => Crc32.Hash(null!));
  }
  ...
  public void Array_And_Span_ProduceSameHash() {
    ...
    var arrayHash = Crc32.Hash(data);
    var spanHash = Crc32.Hash((ReadOnlySpan<byte>)data);
