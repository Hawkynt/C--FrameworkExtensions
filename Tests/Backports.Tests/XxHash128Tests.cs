...
public class XxHash128Tests {
  ...
  public void Hash_EmptyArray_ReturnsConsistentHash() {
    ...
    var hash1 = XxHash128.Hash(data);
    var hash2 = XxHash128.Hash(data);
  ...
  public void Hash_SameDataSameSeed_ReturnsSameHash() {
    ...
    var hash1 = XxHash128.Hash(data, 42);
    var hash2 = XxHash128.Hash(data, 42);
  ...
  public void Hash_DifferentSeeds_ReturnsDifferentHashes() {
    var data = Encoding.UTF8.GetBytes("Test data for hashing");
    var hash1 = XxHash128.Hash(data, 0);
    var hash2 = XxHash128.Hash(data, 1);
  ...
  public void Hash_DifferentData_ReturnsDifferentHashes() {
    ...
    var hash1 = XxHash128.Hash(data1);
    var hash2 = XxHash128.Hash(data2);
  ...
  public void Append_MultipleChunks_ProducesConsistentHash() {
    var data = Encoding.UTF8.GetBytes("Hello, World! This is a longer test string for XXH128 hash algorithm testing.");

    var hasher1 = new XxHash128();
    hasher1.Append(data);
    var hash1 = hasher1.GetCurrentHash();

    var hasher2 = new XxHash128();
    var chunk1 = new byte[20];
    var chunk2 = new byte[20];
    var chunk3 = new byte[data.Length - 40];
    Array.Copy(data, 0, chunk1, 0, 20);
    Array.Copy(data, 20, chunk2, 0, 20);
    Array.Copy(data, 40, chunk3, 0, data.Length - 40);
  ...
  public void Constructor_WithSeed_ProducesDifferentHash() {
    ...
    var hasher1 = new XxHash128(0);
    hasher1.Append(data);
    var hash1 = hasher1.GetCurrentHash();

    var hasher2 = new XxHash128(12345);
    hasher2.Append(data);
    var hash2 = hasher2.GetCurrentHash();
  ...
  public void Append_Span_MultipleChunks_ProducesConsistentHash() {
    ...
    var hasher2 = new XxHash128();
    var spanChunk1 = new byte[20];
    var spanChunk2 = new byte[20];
    var spanChunk3 = new byte[data.Length - 40];
    Array.Copy(data, 0, spanChunk1, 0, 20);
    Array.Copy(data, 20, spanChunk2, 0, 20);
    Array.Copy(data, 40, spanChunk3, 0, data.Length - 40);
    hasher2.Append((ReadOnlySpan<byte>)spanChunk1);
    hasher2.Append((ReadOnlySpan<byte>)spanChunk2);
    hasher2.Append((ReadOnlySpan<byte>)spanChunk3);
    var hash2 = hasher2.GetCurrentHash();
  ...
  public void Hash_NullArray_ThrowsArgumentNullException() {
    Assert.Throws<ArgumentNullException>(() => XxHash128.Hash(null!));
  }
  ...
  [Test]
  [Category("EdgeCase")]
  public void Hash_ExactlyOneStripe_ReturnsValidHash() {
  ...
  [Test]
  [Category("EdgeCase")]
  public void Hash_MultipleStripes_ReturnsValidHash() {
  ...
  [Test]
  [Category("EdgeCase")]
  public void Hash_VeryLargeData_ReturnsValidHash() {
  ...
  public void Array_And_Span_ProduceSameHash() {
    ...
    var arrayHash = XxHash128.Hash(data);
    var spanHash = XxHash128.Hash((ReadOnlySpan<byte>)data);
