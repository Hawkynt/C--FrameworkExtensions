...
public sealed class ImmutableSortedDictionary<TKey, TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IDictionary {
  private readonly SortedDictionary<TKey, TValue> _dictionary;

  /// <summary>
  /// Gets an empty immutable sorted dictionary.
  /// </summary>
  public static readonly ImmutableSortedDictionary<TKey, TValue> Empty = new(new(), Comparer<TKey>.Default, EqualityComparer<TValue>.Default);

  internal ImmutableSortedDictionary(SortedDictionary<TKey, TValue> dictionary, IComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer) {
  ...
  /// <summary>
  /// Gets the key comparer used to order keys in the dictionary.
  /// </summary>
  public IComparer<TKey> KeyComparer { get; }

  /// <inheritdoc />
  IEqualityComparer<TKey> IImmutableDictionary<TKey, TValue>.KeyComparer => EqualityComparer<TKey>.Default;
  ...
  public ImmutableSortedDictionary<TKey, TValue> Add(TKey key, TValue value) {
    var newDict = new SortedDictionary<TKey, TValue>(this._dictionary, this.KeyComparer) { { key, value } };
  ...
  /// </summary>
  public ImmutableSortedDictionary<TKey, TValue> AddRange(IEnumerable<KeyValuePair<TKey, TValue>> pairs) {
    var newDict = new SortedDictionary<TKey, TValue>(this._dictionary, this.KeyComparer);
  ...
  public ImmutableSortedDictionary<TKey, TValue> WithComparers(IComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer) {
    ...
    var newDict = new SortedDictionary<TKey, TValue>(keyComparer);
  ...
  /// <summary>
  /// Enumerates the contents of the immutable sorted dictionary.
  /// </summary>
  public struct Enumerator : IEnumerator<KeyValuePair<TKey, TValue>> {
    private SortedDictionary<TKey, TValue>.Enumerator _enumerator;

    internal Enumerator(SortedDictionary<TKey, TValue>.Enumerator enumerator) => this._enumerator = enumerator;
  ...
  /// <summary>
  /// A builder for creating immutable sorted dictionaries efficiently.
  /// </summary>
  public sealed class Builder : IDictionary<TKey, TValue>, IReadOnlyDictionary<TKey, TValue>, IDictionary {
    private readonly SortedDictionary<TKey, TValue> _dictionary;

    internal Builder(SortedDictionary<TKey, TValue> dictionary, IComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer) {
      this._dictionary = dictionary;
      this.KeyComparer = keyComparer ?? Comparer<TKey>.Default;
      this.ValueComparer = valueComparer ?? EqualityComparer<TValue>.Default;
    }
    ...
    /// <summary>
    /// Creates an immutable sorted dictionary based on the contents of this builder.
    /// </summary>
...
/// <summary>
/// Provides a set of static methods for creating immutable sorted dictionaries.
/// </summary>
public static class ImmutableSortedDictionary {
  ...
  /// <summary>
  /// Creates an empty immutable sorted dictionary with the specified key comparer.
  /// </summary>
  ...
  /// <summary>
  /// Creates an empty immutable sorted dictionary with the specified key and value comparers.
  /// </summary>
  ...
  /// <summary>
  /// Creates a new builder for creating immutable sorted dictionaries.
  /// </summary>
  public static ImmutableSortedDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>() =>
    new(new(), Comparer<TKey>.Default, EqualityComparer<TValue>.Default);

  /// <summary>
  /// Creates a new builder for creating immutable sorted dictionaries with the specified key comparer.
  /// </summary>
  public static ImmutableSortedDictionary<TKey, TValue>.Builder CreateBuilder<TKey, TValue>(IComparer<TKey> keyComparer) =>
    new(new(keyComparer), keyComparer, EqualityComparer<TValue>.Default);

  /// <summary>
  /// Creates a new builder for creating immutable sorted dictionaries with the specified key and value comparers.
  /// </summary>
  ...
  /// <summary>
  /// Creates an immutable sorted dictionary from the specified items.
  /// </summary>
  public static ImmutableSortedDictionary<TKey, TValue> CreateRange<TKey, TValue>(IEnumerable<KeyValuePair<TKey, TValue>> items) {
    ...
    return new(dict, Comparer<TKey>.Default, EqualityComparer<TValue>.Default);
  }

  /// <summary>
  /// Creates an immutable sorted dictionary from the specified items with the specified key comparer.
  /// </summary>
  ...
  {
    /// <summary>
    /// Enumerates a sequence and produces an immutable sorted dictionary of its contents.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary() =>
      CreateRange(source);

    /// <summary>
    /// Enumerates a sequence and produces an immutable sorted dictionary of its contents with the specified key comparer.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary(IComparer<TKey> keyComparer) =>
  ...
  extension<TSource>(IEnumerable<TSource> source)
  {
    ...
    /// </summary>
    public ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector) {
      var dict = new SortedDictionary<TKey, TValue>();
    ...
    /// <summary>
    /// Enumerates and transforms a sequence and produces an immutable sorted dictionary of its contents with the specified key comparer.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector, IComparer<TKey> keyComparer) {
      var dict = new SortedDictionary<TKey, TValue>(keyComparer);
      foreach (var item in source)
        dict.Add(keySelector(item), valueSelector(item));
      return new(dict, keyComparer, EqualityComparer<TValue>.Default);
    ...
    /// <summary>
    /// Enumerates and transforms a sequence and produces an immutable sorted dictionary of its contents with the specified key and value comparers.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TValue> ToImmutableSortedDictionary<TKey, TValue>(Func<TSource, TKey> keySelector, Func<TSource, TValue> valueSelector, IComparer<TKey> keyComparer, IEqualityComparer<TValue> valueComparer) {
      var dict = new SortedDictionary<TKey, TValue>(keyComparer);
      foreach (var item in source)
        dict.Add(keySelector(item), valueSelector(item));
    ...
    /// <summary>
    /// Enumerates a sequence and produces an immutable sorted dictionary of its contents by using the specified key selector function.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TSource> ToImmutableSortedDictionary<TKey>(Func<TSource, TKey> keySelector) {
      var dict = new SortedDictionary<TKey, TSource>();
      foreach (var item in source)
        dict.Add(keySelector(item), item);
      return new(dict, Comparer<TKey>.Default, EqualityComparer<TSource>.Default);
    }

    /// <summary>
    /// Enumerates a sequence and produces an immutable sorted dictionary of its contents by using the specified key selector function and key comparer.
    /// </summary>
    public ImmutableSortedDictionary<TKey, TSource> ToImmutableSortedDictionary<TKey>(Func<TSource, TKey> keySelector, IComparer<TKey> keyComparer) {
      var dict = new SortedDictionary<TKey, TSource>(keyComparer);
      foreach (var item in source)
        dict.Add(keySelector(item), item);
