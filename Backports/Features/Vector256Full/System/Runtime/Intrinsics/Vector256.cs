...
#if !SUPPORTS_VECTOR_256_FULL && !SUPPORTS_VECTOR_256_TYPE
...
public static partial class Vector256Polyfills {
  extension(Vector256) {
    ...
    // Only add these methods when BCL has Vector256 but lacks these operations
    #if SUPPORTS_VECTOR_256_BASE
