...
/// <summary>
/// Represents the slices that exist within a dimension of a read-only tensor span.
/// </summary>
...
public readonly ref struct ReadOnlyTensorDimensionSpan<T> {
  ...
  /// <summary>
  /// Creates a new ReadOnlyTensorDimensionSpan for the specified dimension.
  /// </summary>
  ...
  /// <summary>
  /// Gets the read-only tensor span representing a slice at the specified index.
  /// </summary>
  /// <param name="index">The index of the slice.</param>
  /// <returns>The read-only tensor span for the slice.</returns>
  public ReadOnlyTensorSpan<T> this[int index] {
    get {
  ...
  /// <summary>
  /// Enumerator for ReadOnlyTensorDimensionSpan.
  /// </summary>
  public ref struct Enumerator {
    ...
    /// </summary>
    public ReadOnlyTensorSpan<T> Current => this._span[this._index];
