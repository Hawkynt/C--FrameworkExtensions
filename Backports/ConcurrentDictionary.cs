...
namespace System.Collections.Concurrent {
  ...
  internal
    ...
    public ConcurrentDictionary() => this._items = new Dictionary<TKey, TValue>();
    public ConcurrentDictionary(IEqualityComparer<TKey> comparer) => this._items = new Dictionary<TKey, TValue>(comparer);
