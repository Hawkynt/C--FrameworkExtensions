...
To avoid conflicts with official Microsoft BCL backport packages and ensure optimal compatibility, __FrameworkExtensions.Backports__ uses a hybrid approach:

- __When official packages exist__: For target frameworks where Microsoft provides official backport packages (such as System.Memory, System.Buffers, System.ValueTuple, etc.), this package automatically references and uses those official implementations.

- __When official packages don't exist__: For older target frameworks (like .NET Framework 2.0, 3.5) or for features not covered by official packages, this package provides custom backport implementations.

This approach means:

- ✅ __Users only need to reference `FrameworkExtensions.Backports`__ - all necessary dependencies are included automatically
- ✅ __No package conflicts__ - official implementations are used when available, avoiding type conflicts
- ✅ __Better performance and compatibility__ - official Microsoft implementations are optimized and thoroughly tested
- ✅ __Seamless experience__ - the same API surface works across all target frameworks
...
__Active Packages:__

- __System.Memory__ - Provides `Span<T>`, `ReadOnlySpan<T>`, `Memory<T>`, and `MemoryMarshal` (.NET Framework 4.5+, .NET Standard 2.0)
- __System.Buffers__ - Provides `ArrayPool<T>` (.NET Framework 4.5+, .NET Standard 2.0)
- __System.ValueTuple__ - Provides `ValueTuple` types (.NET Framework 4.0+)
- __System.Runtime.CompilerServices.Unsafe__ - Provides the `Unsafe` class (.NET Framework 4.5+, .NET Standard 1.0+)
- __System.Numerics.Vectors__ - Provides `Vector` types (.NET Framework 4.5+, .NET Standard 2.0)
...
- __Microsoft.Bcl__ - Provides `CallerMemberNameAttribute` and related attributes (.NET Framework 4.0 only)
- __Microsoft.Bcl.Async__ - Provides `TaskAwaiter` and async/await support (.NET Framework 4.0 only)
...
- System.Numerics
  ...
  - [IAdditionOperators](https://learn.microsoft.com/dotnet/api/system.numerics.iadditionoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IAdditiveIdentity](https://learn.microsoft.com/dotnet/api/system.numerics.iadditiveidentity-2)&lt;TSelf, TResult&gt; (marker interface)
  - [IBinaryInteger](https://learn.microsoft.com/dotnet/api/system.numerics.ibinaryinteger-1)&lt;TSelf&gt; (marker interface)
  - [IBinaryNumber](https://learn.microsoft.com/dotnet/api/system.numerics.ibinarynumber-1)&lt;TSelf&gt; (marker interface)
  - [IBitwiseOperators](https://learn.microsoft.com/dotnet/api/system.numerics.ibitwiseoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IComparisonOperators](https://learn.microsoft.com/dotnet/api/system.numerics.icomparisonoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IDecrementOperators](https://learn.microsoft.com/dotnet/api/system.numerics.idecrementoperators-1)&lt;TSelf&gt; (marker interface)
  - [IDivisionOperators](https://learn.microsoft.com/dotnet/api/system.numerics.idivisionoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IEqualityOperators](https://learn.microsoft.com/dotnet/api/system.numerics.iequalityoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IExponentialFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.iexponentialfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IFloatingPoint](https://learn.microsoft.com/dotnet/api/system.numerics.ifloatingpoint-1)&lt;TSelf&gt; (marker interface)
  - [IFloatingPointConstants](https://learn.microsoft.com/dotnet/api/system.numerics.ifloatingpointconstants-1)&lt;TSelf&gt; (marker interface)
  - [IFloatingPointIeee754](https://learn.microsoft.com/dotnet/api/system.numerics.ifloatingpointieee754-1)&lt;TSelf&gt; (marker interface)
  - [IHyperbolicFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.ihyperbolicfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IIncrementOperators](https://learn.microsoft.com/dotnet/api/system.numerics.iincrementoperators-1)&lt;TSelf&gt; (marker interface)
  - [ILogarithmicFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.ilogarithmicfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IMinMaxValue](https://learn.microsoft.com/dotnet/api/system.numerics.iminmaxvalue-1)&lt;TSelf&gt; (marker interface)
  - [IModulusOperators](https://learn.microsoft.com/dotnet/api/system.numerics.imodulusoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [IMultiplicativeIdentity](https://learn.microsoft.com/dotnet/api/system.numerics.imultiplicativeidentity-2)&lt;TSelf, TResult&gt; (marker interface)
  - [IMultiplyOperators](https://learn.microsoft.com/dotnet/api/system.numerics.imultiplyoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [INumber](https://learn.microsoft.com/dotnet/api/system.numerics.inumber-1)&lt;TSelf&gt; (marker interface)
  - [INumberBase](https://learn.microsoft.com/dotnet/api/system.numerics.inumberbase-1)&lt;TSelf&gt; (marker interface)
  - [IPowerFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.ipowerfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IRootFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.irootfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IShiftOperators](https://learn.microsoft.com/dotnet/api/system.numerics.ishiftoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [ISignedNumber](https://learn.microsoft.com/dotnet/api/system.numerics.isignednumber-1)&lt;TSelf&gt; (marker interface)
  - [ISubtractionOperators](https://learn.microsoft.com/dotnet/api/system.numerics.isubtractionoperators-3)&lt;TSelf, TOther, TResult&gt; (marker interface)
  - [ITrigonometricFunctions](https://learn.microsoft.com/dotnet/api/system.numerics.itrigonometricfunctions-1)&lt;TSelf&gt; (marker interface)
  - [IUnaryNegationOperators](https://learn.microsoft.com/dotnet/api/system.numerics.iunarynegationoperators-2)&lt;TSelf, TResult&gt; (marker interface)
  - [IUnaryPlusOperators](https://learn.microsoft.com/dotnet/api/system.numerics.iunaryplusoperators-2)&lt;TSelf, TResult&gt; (marker interface)
  - [IUnsignedNumber](https://learn.microsoft.com/dotnet/api/system.numerics.iunsignednumber-1)&lt;TSelf&gt; (marker interface)
...
- System.Runtime.CompilerServices
  ...
  - [ConditionalWeakTable](https://learn.microsoft.com/dotnet/api/system.runtime.compilerservices.conditionalweaktable-2)&lt;TKey,TValue&gt;
...
- System.Threading
  ...
  - [Volatile](https://learn.microsoft.com/dotnet/api/system.threading.volatile)
...
- System.Linq.Expressions
  - [BinaryExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.binaryexpression)
  - [BlockExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.blockexpression)
  - [CatchBlock](https://learn.microsoft.com/dotnet/api/system.linq.expressions.catchblock)
  ...
  - [ExpressionType](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expressiontype)
  - [ExpressionVisitor](https://learn.microsoft.com/dotnet/api/system.linq.expressions.expressionvisitor)
  - [GotoExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.gotoexpression)
  - [GotoExpressionKind](https://learn.microsoft.com/dotnet/api/system.linq.expressions.gotoexpressionkind)
  - [IndexExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.indexexpression)
  - [InvocationExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.invocationexpression)
  - [LabelExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.labelexpression)
  - [LabelTarget](https://learn.microsoft.com/dotnet/api/system.linq.expressions.labeltarget)
  - [LambdaExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.lambdaexpression)
  - [ListInitExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.listinitexpression)
  - [LoopExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.loopexpression)
  - [MemberAssignment](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberassignment)
  - [MemberBinding](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberbinding)
  - [MemberBindingType](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberbindingtype)
  - [MemberExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberexpression)
  - [MemberInitExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberinitexpression)
  - [MemberListBinding](https://learn.microsoft.com/dotnet/api/system.linq.expressions.memberlistbinding)
  - [MemberMemberBinding](https://learn.microsoft.com/dotnet/api/system.linq.expressions.membermemberbinding)
  - [MethodCallExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.methodcallexpression)
  - [NewArrayExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.newarrayexpression)
  - [NewExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.newexpression)
  - [ParameterExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.parameterexpression)
  - [SwitchCase](https://learn.microsoft.com/dotnet/api/system.linq.expressions.switchcase)
  - [SwitchExpression](https://learn.microsoft.com/dotnet/api/system.linq.expressions.switchexpression)
...
The goal is to make Backports __compiler-complete__ for older targets with the same runtime functionality as modern .NET.
...
- [Polyfill.NET](https://github.com/SimonCropp/Polyfill)
- [PolyShim](https://github.com/Tyrrrz/PolyShim)
- [Theraot.Core](https://github.com/theraot/Theraot)
- [Poly#](https://github.com/Sergio0694/PolySharp)
...
None. The package deliberately carries no dependencies of its own.

## ⚠️ Limitations

- A polyfill supplies the **shape** of a newer API, not necessarily its performance characteristics or its every corner case.
- What the package contributes depends entirely on the target framework: on the newest targets most of it compiles away, because the real BCL already provides it.
- The API reference below documents a single target framework. On older targets the surface is considerably larger.
