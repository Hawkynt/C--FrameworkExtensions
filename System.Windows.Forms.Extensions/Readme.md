...
Every public and protected member of all 487 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/C--FrameworkExtensions/blob/main/System.Windows.Forms.Extensions/REFERENCE.md).
