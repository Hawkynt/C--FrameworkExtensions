...
#region Syntax hightlighting classes
    ...
    public static class SyntaxHighlightPattern {
      ...
      public static ISyntaxHighlightPattern FromPattern(string pattern, ISyntaxStyle style) => new Pattern(new Regex(pattern, RegexOptions.Compiled), style);
      public static ISyntaxHighlightPattern FromPattern(string pattern, IDictionary<string, ISyntaxStyle> styles) => new Pattern(new Regex(pattern, RegexOptions.Compiled), null, new ReadOnlyDictionary<string, ISyntaxStyle>(styles));
      public static ISyntaxHighlightPattern FromPattern(string pattern, RegexOptions options, ISyntaxStyle style) => new Pattern(new Regex(pattern, options | RegexOptions.Compiled), style);
      public static ISyntaxHighlightPattern FromPattern(string pattern, RegexOptions options, IDictionary<string, ISyntaxStyle> styles) => new Pattern(new Regex(pattern, options | RegexOptions.Compiled), null, new ReadOnlyDictionary<string, ISyntaxStyle>(styles));
...
#region Implementation of ISyntaxHighlightPattern
    ...
    private class SyntaxHighlighter {
      private struct RtbState {
        ...
        public static RtbState Save(RichTextBox owner) => new RtbState(owner);
