...
namespace System.Windows.Forms {
  ...
  static partial class TreeViewExtensions {
    ...
    /// </summary>
    private static readonly Dictionary<TreeView, DragDropInstance> _SUBSCRIBED_TREEVIEWS = new Dictionary<TreeView, DragDropInstance>();
    ...
    public static void EnabledDragAndDrop(this TreeView This, Predicate<TreeNode> folderSelector = null, bool allowRootNodeDragging = true, Action<TreeNode, TreeNode, int> onNodeMove = null) {
      ...
      lock (_SUBSCRIBED_TREEVIEWS) {
        ...
        if (_SUBSCRIBED_TREEVIEWS.ContainsKey(This))
          return;
        _SUBSCRIBED_TREEVIEWS.Add(This, new DragDropInstance(This, folderSelector, allowRootNodeDragging, onNodeMove));
    ...
    private static void _OnDisposing(object sender, EventArgs ea) {
      ...
      lock (_SUBSCRIBED_TREEVIEWS) {
        ...
        if (!_SUBSCRIBED_TREEVIEWS.TryGetValue(treeView, out dragDropInstance))
          return;
    ...
    private class DragDropInstance : IDisposable {
      ...
      #region node-map
      private StringBuilder NewNodeMap = new StringBuilder(_INITIAL_NODEMAP_SIZE);
      ...
      public DragDropInstance(TreeView treeView, Predicate<TreeNode> folderSelector, bool canDragRootNodes, Action<TreeNode, TreeNode, int> onNodeMove) {
        ...
        this._dragImageList = new ImageList();
        this._dragScrollTimer = new Timer { Interval = 200, Enabled = false };
      ...
      private void _DrawAddToFolderPlaceholder(TreeNode hoveredNode) {
        ...
        var rightTriangle = new[] {
          new Drawing.Point(rightPos, y + halfHeight + 4),
          new Drawing.Point(rightPos, y + halfHeight + 4),
          new Drawing.Point(rightPos - 4, y + halfHeight),
          new Drawing.Point(rightPos - 4, y + halfHeight - 1),
          new Drawing.Point(rightPos, y + halfHeight - 5)
        };
