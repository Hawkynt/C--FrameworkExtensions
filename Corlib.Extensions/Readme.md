...
Every public and protected member of all 307 types, generated from the built assembly and its XML documentation, is in [REFERENCE.md](https://github.com/Hawkynt/C--FrameworkExtensions/blob/main/Corlib.Extensions/REFERENCE.md).
