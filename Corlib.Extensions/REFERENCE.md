# FrameworkExtensions.Corlib — API reference

[← FrameworkExtensions.Corlib](https://github.com/Hawkynt/C--FrameworkExtensions/blob/main/Corlib.Extensions/Readme.md)
