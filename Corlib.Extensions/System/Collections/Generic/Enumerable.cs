...
public static partial class EnumerableExtensions {
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    /// </exception>
    public IEnumerable<TItem> Prepend(params TItem[] items) {
    ...
    ///   When the given <see cref="IEnumerable{T}" /> is <see langword="null" />
    /// </exception>
    public IEnumerable<TItem> Append(params TItem[] items) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(items);
    ...
    ///   When the given <see cref="IEnumerable{T}" /> is <see langword="null" />
    /// </exception>
    public IEnumerable<TItem> Prepend(IEnumerable<TItem> items) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(items);
    ...
    ///   When the given <see cref="IEnumerable{T}" /> is <see langword="null" />
    /// </exception>
    public IEnumerable<TItem> Append(IEnumerable<TItem> items) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(items);
    ...
    /// </example>
    public IEnumerable<TItem> FilterIfNeeded(Func<TItem, string> selector, string query, bool ignoreCase = false)
    ...
    /// </remarks>
    public IEnumerable<TItem> FilterIfNeeded(string query, params Func<TItem, string>[] selectors)
    ...
    /// This method allows for filtering across multiple columns. Each filter term is matched against each column, combining column matches with OR and combining filter terms with AND.
    /// </remarks>
    public IEnumerable<TItem> FilterIfNeeded(string query, bool ignoreCase, params Func<TItem, string>[] selectors) {
      if (@this == null)
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public IEnumerable<IChangeSet<TItem>> CompareTo(IEnumerable<TItem> other, IEqualityComparer<TItem> comparer = null) {
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    [DebuggerStepThrough]
    public IEnumerable<TItem> ToNullIfEmpty() {
      switch (@this) {
    ...
    /// </returns>
    [DebuggerStepThrough]
    public HashSet<TItem> ToHashSet(int initialCapacity) {
      Against.ArgumentIsNull(@this);
    ...
    public HashSet<TResult> ToHashSet<TResult>(Func<TItem, TResult> selector, IEqualityComparer<TResult> comparer = null) {
      Against.ArgumentIsNull(@this);
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public bool AreEqual(IEnumerable<TItem> other, IEqualityComparer<TItem> comparer = null) {
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    public Tuple<IEnumerable<TItem>, IEnumerable<TItem>> Split(Func<TItem, bool> predicate) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(predicate);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool ContainsNot(TItem item, IEqualityComparer<TItem> comparer = null) {
      Against.ThisIsNull(@this);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool ContainsNotAny(IEnumerable<TItem> items, IEqualityComparer<TItem> comparer = null) {
      Against.ThisIsNull(@this);
    ...
    /// </returns>
    public bool ContainsAny(IEnumerable<TItem> list, IEqualityComparer<TItem> equalityComparer = null) {
      Against.ThisIsNull(@this);
    ...
    [DebuggerStepThrough]
    public void ForEach(Action<TItem, int> action) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(action);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public void ParallelForEach(Action<TItem> action) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(action);
    ...
    /// </summary>
    /// <param name="action">The call to execute.</param>
    public void ParallelForEach(Action<TItem, int> action) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(action);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<TResult> ConvertAll<TResult>(Func<TItem, TResult> converter) {
      Against.ThisIsNull(@this);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<TResult> ConvertAll<TResult>(Func<TItem, int, TResult> converter) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(converter);
    ...
    /// </returns>
    public IEnumerable<TItem> AsProgressReporting(Action<double> progressCallback, bool delayed = false) {
      Against.ThisIsNull(@this);
    ...
    ///   A new enumeration which automatically calls the progress callback when items are pulled.
    /// </returns>
    public IEnumerable<TItem> AsProgressReporting(Action<long, long> progressCallback, bool delayed = false) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(progressCallback);
    ...
    public IEnumerable<TItem> AsProgressReporting(
      int length,
    ...
    /// <returns></returns>
    public bool All(Func<TItem, int, bool> condition) {
      Against.ThisIsNull(@this);
    ...
    public IEnumerable<TItem> Distinct<TCompare>(Func<TItem, TCompare> selector) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    [DebuggerStepThrough]
    public int IndexOrDefault(Func<TItem, bool> selector, int defaultValue = -1) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
    ...
    /// <returns>The index of the matched item or the given default value.</returns>
    [DebuggerStepThrough]
    public int IndexOrDefault(Func<TItem, bool> selector, Func<int> defaultValue) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
    ...
    /// <returns>The index of the matched item or the given default value.</returns>
    [DebuggerStepThrough]
    public int IndexOrDefault(Func<TItem, bool> selector, Func<IEnumerable<TItem>, int> defaultValue) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
      Against.ArgumentIsNull(defaultValue);
    ...
    public int IndexOf(TItem item) => IndexOrDefault(@this, a => Equals(a, item), -1);
  }
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    public bool TryGet<TResult>(Func<IEnumerable<TItem>, TResult> selector, out TResult result) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
    ...
    /// <returns><see langword="true" /> when the enumeration contains at least one item; otherwise, <see langword="false" />.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetMax(out TItem result)
    ...
    /// <returns><see langword="true" /> when the enumeration contains at least one item; otherwise, <see langword="false" />.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetMaxBy<TResult>(Func<TItem, TResult> selector, out TItem result) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
    ...
    /// <returns><see langword="true" /> when the enumeration contains at least one item; otherwise, <see langword="false" />.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetMin(out TItem result)
    ...
    /// <returns><see langword="true" /> when the enumeration contains at least one item; otherwise, <see langword="false" />.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool TryGetMinBy<TResult>(Func<TItem, TResult> selector, out TItem result) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(selector);
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public TItem FirstOrDefault(Func<TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public TItem FirstOrDefault(Func<IEnumerable<TItem>, TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(defaultValueFactory);
    ...
    [DebuggerStepThrough]
    public TItem FirstOrDefault(Func<TItem, bool> selector, Func<TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(selector);
      Against.ArgumentIsNull(defaultValueFactory);
    ...
    /// <returns>The matched item or the given default value.</returns>
    [DebuggerStepThrough]
    public TItem FirstOrDefault(Func<TItem, bool> selector, Func<IEnumerable<TItem>, TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(selector);
      Against.ArgumentIsNull(defaultValueFactory);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem LastOrDefault(Func<TItem, bool> selector, Func<TItem> defaultValueFactory)
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem LastOrDefault(Func<TItem, bool> selector, Func<IEnumerable<TItem>, TItem> defaultValueFactory)
      => FirstOrDefault(@this.Reverse(), selector, defaultValueFactory);
  }
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem LastOrDefault(Func<TItem> defaultValueFactory)
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem LastOrDefault(Func<IEnumerable<TItem>, TItem> defaultValueFactory)
      => FirstOrDefault(@this.Reverse(), defaultValueFactory);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<TItem> OrderBy() {
      Against.ThisIsNull(@this);
    ...
    [DebuggerStepThrough]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IEnumerable<TItem> OrderByDescending() {
      Against.ThisIsNull(@this);
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public IEnumerable<TItem> TakeUntil(Func<TItem, bool> predicate) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(predicate);
    ...
    /// <returns></returns>
    [DebuggerStepThrough]
    public IEnumerable<TItem> SkipUntil(Func<TItem, bool> predicate) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(predicate);
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    public async Task DoForEveryItemAsync(Action<TItem> action) {
      Against.ThisIsNull(@this);
      Against.ArgumentIsNull(action);
    ...
    /// </example>
    [DebuggerStepThrough]
    public bool TryGetSingle(out TItem result) {
      Against.ArgumentIsNull(@this);
  ...
  extension<TItem>(IEnumerable<TItem> @this)
  {
    ...
    /// </example>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem SingleOrDefault(Func<TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(defaultValueFactory);
    ...
    /// </example>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TItem SingleOrDefault(Func<IEnumerable<TItem>, TItem> defaultValueFactory) {
      Against.ArgumentIsNull(@this);
      Against.ArgumentIsNull(defaultValueFactory);
    ...
    ///   <see langword="false" />.
    /// </returns>
    public bool HasSingle(TItem value) {
      Against.ThisIsNull(@this);
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool HasNoSingle(TItem value)
    ...
    ///   <see langword="false" />.
    /// </returns>
    public bool HasMultiple(TItem value) {
      Against.ThisIsNull(@this);
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool HasNoMultiple(TItem value)
    ...
    ///   <see langword="false" />.
    /// </returns>
    public bool HasSingle(Predicate<TItem> predicate) {
      Against.ThisIsNull(@this);
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool HasNoSingle(Predicate<TItem> predicate)
    ...
    ///   otherwise, <see langword="false" />.
    /// </returns>
    public bool HasMultiple(Predicate<TItem> predicate) {
      Against.ThisIsNull(@this);
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool HasNoMultiple(Predicate<TItem> predicate)
