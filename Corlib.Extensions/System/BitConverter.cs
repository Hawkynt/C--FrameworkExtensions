...
public static class BitConverterExtension {
  ...
  public static long ToLong(byte[] arrBytes, int intOffset = 0) =>
    arrBytes[intOffset] | ((long)arrBytes[++intOffset] << 8) | ((long)arrBytes[++intOffset] << 16) | ((long)arrBytes[++intOffset] << 24) |
  ...
  public static long? ToNLong(byte[] arrBytes, int intOffset = 0) =>
    arrBytes[intOffset++] == ISNULL ? null : arrBytes[intOffset] | ((long) arrBytes[++intOffset] << 8) | ((long) arrBytes[++intOffset] << 16) | ((long) arrBytes[++intOffset] << 24) |
                                             ((long) arrBytes[++intOffset] << 32) | ((long) arrBytes[++intOffset] << 40) | ((long) arrBytes[++intOffset] << 48) | ((long) arrBytes[++intOffset] << 56);
  ...
  public static ulong ToQWord(byte[] arrBytes, int intOffset = 0) =>
    arrBytes[intOffset] | ((ulong)arrBytes[++intOffset] << 8) | ((ulong)arrBytes[++intOffset] << 16) | ((ulong)arrBytes[++intOffset] << 24) |
  ...
  public static ulong? ToNQWord(byte[] arrBytes, int intOffset = 0) =>
    arrBytes[intOffset++] == ISNULL ? null : arrBytes[intOffset] | ((ulong) arrBytes[++intOffset] << 8) | ((ulong) arrBytes[++intOffset] << 16) | ((ulong) arrBytes[++intOffset] << 24) |
                                             ((ulong) arrBytes[++intOffset] << 32) | ((ulong) arrBytes[++intOffset] << 40) | ((ulong) arrBytes[++intOffset] << 48) | ((ulong) arrBytes[++intOffset] << 56);
