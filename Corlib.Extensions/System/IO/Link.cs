...
public static partial class LinkExtensions {
  ...
  public static IEnumerable<FileInfo> GetHardLinkTargets(this FileInfo @this) => _InternalGetHardLinkTargets(@this).Select(f=>new FileInfo(f)).Where(f=>f.FullName!=@this.FullName);
