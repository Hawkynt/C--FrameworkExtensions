...
public static partial class DirectoryInfoExtensions {
  ...
  /// <summary>
  ///   Renames the directory represented by this <see cref="DirectoryInfo" /> instance to a new name in the same parent
  ///   directory.
  /// </summary>
  ...
  ///   Thrown if a directory with the new name already exists, or if any other I/O error occurs
  ///   during the renaming.
  /// </exception>
  /// <example>
  ///   <code>
  ...
  ///   Thrown if the directory does not exist or an error occurs when trying to delete
  ///   the files or subdirectories.
  /// </exception>
  /// <exception cref="System.Security.SecurityException">
  ///   Thrown if the caller does not have the required permission to
  ///   delete files or directories.
  /// </exception>
  /// <exception cref="System.NotSupportedException">
  ///   Thrown if the operation is attempted on a directory with a read-only
  ///   file system.
  /// </exception>
  /// <example>
  ///   <code>
  ...
  /// </example>
  /// <remarks>
  ///   This method is destructive and irreversible. It will delete all contents within the directory but not the directory
  ///   itself.
    ...
    foreach (var item in @this.EnumerateFileSystemInfos())
      switch (item) {
        ...
        case DirectoryInfo directory:
          ...
          continue;
        default: throw new NotSupportedException("Unknown FileSystem item");
      }
  }
      ...
      try {
        foreach (var item in directory.EnumerateFileSystemInfos())
          switch (item) {
            ...
            default: throw new NotSupportedException("Unknown FileSystemInfo item");
          }
      } finally {
  ...
  /// <param name="recursionFilter">
  ///   The filter to use for recursing into sub-directories (Walks on <c>true</c>; otherwise,
  ///   skips recursion).
  /// </param>
  /// <returns>
  ///   The FileSystemInfos
  ...
  ///   If <see langword="true" />, the case will be ignored; otherwise, the filesystem will be
  ///   queried for the exact casing.
  /// </param>
  /// <param name="subdirectories">An array of relative paths to the subdirectory.</param>
  /// <returns>A <see cref="DirectoryInfo" /> instance pointing to the specified subdirectory.</returns>
  /// <exception cref="NullReferenceException">Thrown if <paramref name="this" /> is <see langword="null" />.</exception>
